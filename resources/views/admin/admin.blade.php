...
<head>
    ...
    <style>
        ...
        .bg-sidebar { background: #010101; }
        .cta-btn { color: #010101; }
        .upgrade-btn { background: #FD7272; }
        .upgrade-btn:hover { background: #0038fd; }
        .active-nav-link { background: #FD7272; }
...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        <div class="p-6">
            <a href="index.html" class="text-white text-3xl font-semibold uppercase hover:text-gray-300">LARGE</a>
        </div>
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <a href="{{route('admin.artikel')}}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            ...
            <div class="px-6">
                ...
                <i class="fas fa-plus mr-3"></i> Buat Kategori
            </button>
            </div>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
            ...
            <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
                ...
                <a href="#" class="block px-4 py-2 account-link text-white" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign Out</a>
                    <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                        @csrf
                    </form>
            </nav>
